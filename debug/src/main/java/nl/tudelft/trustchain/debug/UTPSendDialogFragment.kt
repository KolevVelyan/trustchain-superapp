...
class UTPSendDialogFragment(private val otherPeer: Peer, private val community: Community)
    ...
    private fun showInfoDialog() {
        val dialogBuilder = AlertDialog.Builder(context)
            ...
            .setMessage("The \"Sender speed\" section is for tracking the speed of the UTP transfer. It updates as the transfer progresses. \n" +
                "\n" +
                "The text next to the info button displays how many unique UTP packets (of max size) are expected to be sent. It updates with the current highest sequence number of the sender.\n" +
                "\n" +
                "The two lines below in the section display for the sender how much data it has sent or received (with approximate data transfer rate), respectively, as well as there are three flags (S, A, and TP).\n" +
                "\n" +
                "For \"Sent\":\n" +
                "S stands for highest sequence number sent by sender\n" +
                "A stands for highest acknowledgment sent by sender (becomes 1 when sender and receiver have connected)\n" +
                "TP is total packets sent by receiver\n" +
                "\n" +
                "For \"Rcvd\":\n" +
                "S stands for highest sequence number received by sender (becomes 1 when sender and receiver have connected)\n" +
                "A stands for highest acknowledgment received by sender\n" +
                "TP is total packets received by sender (sometimes the total data received is more that the actual data because of retransmissions)\n" +
                "\n" +
